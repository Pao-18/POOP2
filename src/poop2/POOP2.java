...
public class POOP2 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Generación del métdod Do-While
         */
        do {            
